  ...
  return (
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-8 pb-16">
        ...
        <h1 className="mt-5 font-[family-name:var(--font-heading)] text-[22px] font-bold text-[var(--brand)]">
          Thank you!
        </h1>
        ...
        <Link
          href="/dashboard"
          className="mt-7 flex w-full items-center justify-center gap-2 rounded-xl bg-[var(--brand-accent)] px-3.5 py-3.5 font-[family-name:var(--font-heading)] text-[15px] font-semibold text-[var(--brand)]"
        >
          <svg
            width="16"
            height="16"
