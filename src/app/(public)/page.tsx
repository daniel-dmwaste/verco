    ...
    <div className="flex min-h-screen flex-col">
      ...
      <nav className="flex h-16 items-center gap-8 bg-[#293F52] px-8">
        ...
        <div className="hidden flex-1 items-center justify-end gap-6 lg:flex">
          <a href="#how-it-works" className="text-sm font-medium text-[#C7D3DD] hover:text-white">
            How it works
          </a>
          <a href="#services" className="text-sm font-medium text-[#C7D3DD] hover:text-white">
            Services
          </a>
          <a href="#faqs" className="text-sm font-medium text-[#C7D3DD] hover:text-white">
            FAQs
          </a>
          <Link href="/dashboard" className="text-sm font-medium text-[#C7D3DD] hover:text-white">
            My Bookings
          </Link>
          <Link
            href="/book"
